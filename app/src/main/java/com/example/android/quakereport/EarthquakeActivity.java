...
public class EarthquakeActivity extends AppCompatActivity
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            USGS_REQUEST_URL =
            "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime="+String.valueOf(yearStart)+"&endtime="+String.valueOf(yearEnd)+"&minmag="+quakeMinMag+"&limit="+String.valueOf(quakeNum);

            Log.i(LOG_TAG, "TEST: EarthQuakeUtility onCreate() called");
...
//respond to menu item selection
        switch (item.getItemId()) {
            ...
            case R.id.settings:
                ...
                startActivity(new Intent(this, QuakeAppSettings.class));
        ...
        public void onLoaderReset(Loader<List<Earthquake>> loader) {
            ...
            mAdapter.clear();
            Log.i(LOG_TAG, "onLoaderReset: TEST On Loader Resetted!");
        }
    }